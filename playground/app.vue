<template>
  <div>
    <div class="antialiased bg-white dark:bg-black text-black dark:text-white min-h-screen place-content-center flex flex-col items-center justify-center text-sm sm:text-base">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-10 gap-6 max-w-[960px] px-4">
          <div class="col-span-2 lg:col-span-10 relative get-started-gradient-border">
            ...
            <div class="w-full absolute inset-x-0 flex justify-center -top-[58px]">
              <img src="nuxt nuxt main packages-ui-templates_public_icons/get-started.svg" class="hidden dark:block">
              <img src="nuxt nuxt main packages-ui-templates_public_icons/get-started-light.svg" class="dark:hidden">
            </div>
            <div class="flex flex-col rounded-xl items-center gap-y-4 pt-[58px] px-4 sm:px-28 pb-6 z-10">
              ...
              <p class="mb-2 text-center">Check the latest values on Dexscreener.</p>
              <a href="https://dexscreener.com" target="_blank" class="text-blue-500">Go to Dexscreener</a>
            </div>
          </div>
          <div class="lg:min-h-min sm:min-h-[220px] md:min-h-[180px] col-span-2 sm:col-span-1 lg:col-span-6 text-black dark:text-white rounded-xl modules-container relative items-center justify-center border border-gray-200 dark:border-transparent hover:border-transparent">
            ...
            <a href="https://twitter.com/watcherguru" target="_blank" class="py-6 px-5 rounded-xl flex items-center justify-center gap-x-4 dark:border-none bg-white dark:bg-gray-900 sm:min-h-[220px] md:min-h-[180px] lg:min-h-min">
              <img src="nuxt nuxt main packages-ui-templates_public_icons/modules-color-light.svg" alt="modules icon" class="modules-image-color-light">
              <img src="nuxt nuxt main packages-ui-templates_public_icons/modules-color.svg" alt="modules icon" class="modules-image-color-dark">
              <img src="nuxt nuxt main packages-ui-templates_public_icons/modules-light.svg" alt="modules icon" class="modules-image-light">
              <img src="nuxt nuxt main packages-ui-templates_public_icons/modules.svg" alt="modules icon" class="modules-image-dark">
          ...
          <div class="row-span-2 col-span-2 order-last lg:order-none lg:col-span-4 text-black dark:text-white documentation-container rounded-xl relative items-center justify-center border border-gray-200 dark:border-transparent hover:border-transparent">
            ...
            <a href="https://fantasy.top" target="_blank" class="rounded-xl flex lg:flex-col items-center justify-center gap-y-4 bg-white dark:bg-gray-900">
              <div class="py-6 lg:py-7 px-5 rounded-xl flex flex-col sm:flex-row lg:flex-col items-center justify-center gap-y-2 ">
                <div class="flex flex-col space-y text-black dark:text-white">
                  ...
                  <p class="text-gray-700 dark:text-gray-300">
                    Discover the world of fantasy.
                  </p>
                </div>
                <img src="nuxt nuxt main packages-ui-templates_public_icons/documentation-color-light.svg" alt="documentation icon" class="documentation-image-color-light h-32 sm:h-34">
                <img src="nuxt nuxt main packages-ui-templates_public_icons/documentation-color.svg" alt="documentation icon" class="documentation-image-color-dark h-32 sm:h-34">
                <img src="nuxt nuxt main packages-ui-templates_public_icons/documentation-light.svg" alt="documentation icon" class="documentation-image-light h-32 sm:h-34">
                <img src="nuxt nuxt main packages-ui-templates_public_icons/documentation.svg" alt="documentation icon" class="documentation-image-dark h-32 sm:h-34">
              </div>
            </a>
          </div>
          <div class="lg:min-h-min sm:min-h-[220px] md:min-h-[180px] col-span-2 sm:col-span-1 lg:col-span-6 text-black dark:text-white rounded-xl examples-container relative items-center justify-center border border-gray-200 dark:border-transparent hover:border-transparent">
            ...
            <a href="https://opensea.io" target="_blank" class="py-6 px-5 rounded-xl flex items-center justify-center gap-x-4 bg-white dark:bg-gray-900 sm:min-h-[220px] md:min-h-[180px] lg:min-h-min">
              <img src="nuxt nuxt main packages-ui-templates_public_icons/examples-color-light.svg" alt="examples icon" class="examples-image-color-light">
              <img src="nuxt nuxt main packages-ui-templates_public_icons/examples-color.svg" alt="examples icon" class="examples-image-color-dark">
              <img src="nuxt nuxt main packages-ui-templates_public_icons/examples-light.svg" alt="examples icon" class="examples-image-light">
              <img src="nuxt nuxt main packages-ui-templates_public_icons/examples.svg" alt="examples icon" class="examples-image-dark">
              <div class="flex flex-col space-y text-black dark:text-white">
                <h3 class="font-semibold text-xl">
                  NFTs
                </h3>
                <p class="text-gray-700 dark:text-gray-300">
                  Explore the world of NFTs on OpenSea.
                </p>
              </div>
            </a>
          </div>
        ...
        <div class="mx-auto sm:px-6 lg:px-8 px-4 w-full">
          <div class="flex flex-col items-center gap-3 sm:flex-row sm:justify-between">
            <div class="flex flex-col-reverse items-center gap-3 sm:flex-row">
              <span class="text-sm text-gray-700 dark:text-gray-300">© 2016-{{ new Date().getFullYear() }} Nuxt - MIT License</span>
            </div>

            <ul class="flex items-center justify-end gap-3">
              <li>
                <a href="https://chat.nuxt.dev" target="_blank" class="focus-visible:ring-2 text-gray-700 hover:text-black dark:text-gray-300 dark:hover:text-white">
              ...
              <li>
                <a href="https://twitter.nuxt.dev" target="_blank" class="focus-visible:ring-2 text-gray-700 hover:text-black dark:text-gray-300 dark:hover:text-white">
